...
class ResNetMulti(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.conv45 = nn.Conv2d(2048, 256, kernel_size=1, stride=1, bias=False)  # change
        self.bn45 = nn.BatchNorm2d(256, affine=affine_par)
        for i in self.bn45.parameters():
            i.requires_grad = False
        self.relu = nn.ReLU(inplace=True)
        self.relu = nn.ReLU(inplace=True)
